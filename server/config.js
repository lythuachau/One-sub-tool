...
const PORTS = {
  ...
  OMNIVOICE: parseInt(process.env.OMNIVOICE_PORT || process.env.CHATTERBOX_PORT) || 3036,
  CHATTERBOX: parseInt(process.env.OMNIVOICE_PORT || process.env.CHATTERBOX_PORT) || 3036
};
